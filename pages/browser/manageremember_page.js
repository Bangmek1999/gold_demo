...
const ManagerememberPage = ({ user }) => {
  ...
  const OnDecline = async (e) => {
    ...
    axios({
      ...
      (response) => {
        ...
        return Swal.fire({
          icon: "success",
          title: "เรียบร้อย",
          text: "ไม่เพิ่มข้อมูลผู้ใช้สำเร็จ",
        });
      },
      (error) => {
        console.log(error);
    ...
    // noti user
    var messages =
      "ขออภัย! บัญชีผู้ใช้ของท่านไม่ผ่านการตรวจสอบ กรุณาทำรายการใหม่อีกครั้ง กดลิงค์ https://liff.line.me/1656518612-LN476NJy";
    var data = {
      messages: messages,
  ...
  const OnApprove = async (e) => {
    ...
    var messages =
      "การสมัครสมาชิกของท่านผ่านการตรวจสอบและได้รับการยืนยันเรียบร้อยแล้ว กดลิงค์ https://liff.line.me/1656518612-LN476NJy เพื่อกำหนดรหัสผ่าน";
    var data = {
      messages: messages,
      user_id: e.user_line_id,
    };
